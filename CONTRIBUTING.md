...
that your question is tagged with the `bddocs` tag when asking it on
...
3. Make sure you provide a suitable amount of information to work with. This
   ...
   - Tell us **what actually happens**. It's not helpful for you to say "it
     ...
     expected result?
   - Tell us **what version of Bddocs you're using**, and
     **how you installed it**. Different versions of behave
     differently and have different bugs, and some distributors
...
Third-party patches are essential for keeping Bddocs great. We want to keep 
